...
const sendToDiscord = async (webhookUrl: string, record: any, individualPhotoUrl: string, screenshots: string[]): Promise<boolean> => {
  try {
    ...
    if (individualPhotoUrl) {
      try {
        ...
        if (photoBase64) {
          ...
          formData.append('files[0]', photoBlob, '/images/IndividualPhoto.jpg');
        }
      } catch (error) {
