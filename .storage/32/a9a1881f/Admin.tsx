...
import { getCurrentUser, getUsers, updateUserRole, deleteUser, isComando, getRoleLabel } from '@/lib/auth';
...
export default function Admin() {
  ...
  if (!currentUser || !isComando()) return null;
                    ...
                    {pendingUsers.map(user => (
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            onClick={() => handleApprove(user.id, 'comando')}
                            size="sm"
                      ...
                      <div className="flex gap-2 items-center">
                        ...
                        >
                          ...
                          <SelectContent className="bg-slate-800 border-slate-600">
                            ...
                            <SelectItem value="comando" className="text-white">Comando</SelectItem>
                          </SelectContent>
                        </Select>
                        {user.username !== 'admin' && (
                          <Button
