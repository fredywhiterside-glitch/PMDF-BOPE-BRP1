      ...
      if (individualData) {
        try {
          ...
          if (parsed.individualName) {
            ...
            setFormData(prev => ({ 
              ...prev, 
              individualName: parsed.individualName,
              serverId: parsed.serverId || '',
              fixedId: parsed.fixedId || ''
            }));
            ...
            if (photos.length > 0) {
              ...
              setScreenshots([photos[0]]);
              toast.success(`Dados carregados! ${photos.length} foto(s) disponível(is)`);
            }
          }
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className="bg-slate-800 border-slate-600 text-white focus:border-yellow-500"
                  placeholder="ID fixo do indivíduo (opcional)"
                  disabled={loading}
                />
              </div>
