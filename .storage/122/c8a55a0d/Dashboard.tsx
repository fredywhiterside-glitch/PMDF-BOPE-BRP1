...
import { getRecords, updateRecord, deleteRecord, addLog, getSettings, getAllIndividuals, getRecordsByIndividual, clearAllRecords, getStorageUsage } from '@/lib/storage';
...
export default function Dashboard() {
  ...
  const [storageUsage, setStorageUsage] = useState({ used: 0, total: 10, percentage: 0 });
          ...
          {currentView === 'settings' && isAdmin() && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-400">Gerencie o armazenamento e dados do sistema</p>
              </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-slate-700">
                    ...
                    <p className="text-slate-400 text-sm mb-4">
                      As imagens são automaticamente comprimidas para economizar espaço. Se o armazenamento estiver cheio, você pode limpar todos os registros abaixo.
                    </p>
                    <Button
