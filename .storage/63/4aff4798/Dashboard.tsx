...
import { Plus, LogOut, FileText, Edit, Trash2, Search, Home, FolderOpen, Image as ImageIcon, Users, UserCheck, BookOpen } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const [currentView, setCurrentView] = useState<'home' | 'records' | 'gallery' | 'pending' | 'members'>('home');
  ...
  const allImages = useMemo(() => {
    const images: Array<{ url: string; recordName: string; recordId: string }> = [];
                ...
                <CardContent>
                  <ol className="space-y-3 text-slate-300">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span>Adicione fotos de evidência: use a Galeria para reutilizar fotos, faça upload ou pressione Ctrl+V para colar</span>
                    </li>
                    <li className="flex gap-3">
                      ...
                      <span>Revise todas as informações e clique em "Salvar Registro"</span>
                    </li>
                    <li className="flex gap-3">
                      ...
                      <span>O registro será automaticamente enviado para o Discord configurado</span>
                    </li>
                  </ol>
                </CardContent>
              </Card>
