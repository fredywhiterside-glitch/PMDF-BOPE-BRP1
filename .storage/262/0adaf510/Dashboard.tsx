...
export default function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:relative z-40 w-64 bg-slate-900/95 backdrop-blur-xl border-r border-slate-700 flex flex-col transition-transform duration-300 h-screen relative overflow-hidden`}>
        ...
        <div className="relative z-10 p-6 border-b border-slate-700">
        ...
        <div className="relative z-10 p-4 border-t border-slate-700 space-y-3">
